...
{
    if (tecla=='O' || tecla=='o') {
        P1_objeto_activo = (P1_objeto_activo+1) %P1_numero_objetos;
        return true;
    }
    else
        return false;
...
void P1_DibujarObjetos( unsigned modo )
{
    ...
    if (P1_objeto_activo==1) {
        cubo->visualizar(modo);
    }
    if (P1_objeto_activo==2) {
        cilindro->visualizar(modo);
    }
    if (P1_objeto_activo==3) {
        cono->visualizar(modo);
    }
    if (P1_objeto_activo==4) {
        tri->visualizar(4);
    }
